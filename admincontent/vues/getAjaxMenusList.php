...
<div class="card-header">
                  <h4>Contenu de la barre de menu</h4>
                    ...
                    <table id="data-table-simple" class="responsive-table table-striped display" cellspacing="0">
                      <thead>
                        <tr>
                          ...
                          <th><i class="fa fa-automobile"></i> Lien</th>
            ...
            foreach($listElements as $element)
            {
              if($element['status']==1)
              {
                ...
                <td id="tdElementContent<?php echo $element['id_element'] ; ?>"><?php echo $element['content'];  ?></td>
                <td id="tdElementLink<?php echo $element['id_element'] ; ?>"><?php echo $element['link'];  ?></td>
