                    ...
                    <table class="table table-striped mb-0">
                      ...
                      <tbody>
                        ...
                        $i = 0 ;
                          ...
                          <td>
                            <a class="btn btn-primary btn-action mr-1 btModifCategory" data-toggle="tooltip" title="Modifier" id="btModifCategory<?php echo $category['id_category']; ?>"><i class="fas fa-pencil-alt"></i></a>
                            <a class="btn btn-danger btn-action btDeleteCategory" data-toggle="tooltip" title="Supprimer" data-confirm="Are You Sure?|This action can not be undone. Do you want to continue?" data-confirm-yes="alert('Deleted')" id="btReject<?php echo $category['id_category']; ?>"><i class="fas fa-trash"></i></a>
                          </td>
                        </tr>
                              <?php
                            }
