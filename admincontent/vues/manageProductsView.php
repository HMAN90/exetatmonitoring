...
<head>
    ...
    <title>MABELECOOP ADMINISTRATION</title>
    <!-- Favicons-->
        ...
        <section id="content">
          ...
          <div class="container">
            ...
            <div id="table-datatables">
                <!-- Element Showed -->
                <a class="waves-effect waves-light btn gradient-45deg-light-blue-cyan gradient-shadow border-round mr-1 modal-trigger" href="#modalAddProduct" >Ajouter un produit</a>
<!-- Tap Target Structure -->
<div class="col s12">
                    <div class="fixed-action-btn" style="bottom: 45px; right: 24px;">
                      <a id="btAddProduct" class="btn btn-floating btn-large cyan modal-trigger" href="#modalAddProduct">
              ...
              <div id="card-alert" class="card amber accent-4">
                    <div class="card-content white-text">
                      <p>
                          ...
                          ($mode=="successAddProductsLink")
                        {
                         ...
                         elseif
                          ($mode=="successUpdateProductsLink")
                        {
                          ?>
                         ...
                         elseif
                          ($mode=="successDeleteProductsLink")
                        {
                          ?>
                    ...
                    elseif(substr($mode, 0,5) == "error")
                    {
                      ...
                      elseif($mode=="errorUpdateProduct")
                      {
                        if(isset($data['errorMessage']))
                          $errorMessage = $data['errorMessage'] ;
                        else
                      ...
                      elseif($mode=="errorDeleteProduct")
                      {
                        if(isset($data['errorMessage']))
                          $errorMessage = $data['errorMessage'] ;
                        else
                      ...
                      elseif($mode=="errorAddProductsLink")
                      {
                        if(isset($data['errorMessage']))
                          $errorMessage = $data['errorMessage'] ;
                        else
            ...
            -->
              ...
              <td><img style="width:50px" src="<?php echo $root ; ?>media/images/products/<?php echo $product['product_logo'] ;  ?>"></td>
							
							<td><a href="<?php echo $root ; ?>products/manage/<?php echo $product['id_product'] ; ?>"><i class="fa fa-cogs"></i>Gérer</a>
              </td>
						</tr>
...
<div class="modal fade" id="modalAddProductsLink" tabindex="-1" role="dialog">
    ...
    <div class="modal-content">
      <div class="card card-signup card-plain">
        ...
        <div class="modal-body">
                ...
                <div class="row margin">
                  <div class="input-field col s12">
                    ...
                    <select  name="id_catégorie_parent" class="">
                      ...
                      <?php 
                        foreach ($listProducts as $parent) {
                          ?>
          ...
          <input type="hidden" name="operation" value="exeAddProductLink">
                  ...
                  <div class="col s12 m3">
                    <div class="card gradient-shadow gradient-45deg-purple-deep-purple border-radius-3">
                      <div class="card-content center">
                        ...
                        <p class="white-text lighten-4"><a href="<?php echo $root ; ?>ressourcesadmin/" class="waves-effect waves-light  btn gradient-shadow border-round mr-1" style="background-color: transparent;color: #fff;text-transform: capitalize;"><?php //echo $productsNumber ; ?></a></p>
                      </div>
                    </div>
                  </div>
                  <div class="col s12 m3">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
        <div class="modal-header" style="background:#ff0000 !important;padding:13px;border-radius:5px;box-shadow:14px 15px 25px rgba(0,0,0,0.2);">
          <h5 class="modal-title" style="color:#fff;"><i class="fa fa-users"></i> Ajouter un produit <!--principal(point d'entrée  --></h5>
        </div>
        <div class="modal-body">
            <div class="container">
              <form class="form" enctype="multipart/form-data" method="post" action="<?php echo $root ; ?>admin/products/add/">
                <div class="card-body">
                  <div class="row margin">
                    ...
                    <div class="input-field col s12 m6 l6">
                      <i class="prefix pt-5 fa fa-envelope" ></i>
                      <select id="categoriesBelonging" name="categories_belonging[]" multiple="multiple" required="">
                      ...
                      <label for="designation" class="center-align">Catégories</label>
                    </div>
                ...
                <div class="row margin">
                    <div class="input-field col s12 m6 l6">
                      ...
                      <label for="price" class="center-align">Prix</label>
                    </div>
                    <div class="input-field col s12 m6 l6">
                      <i class="prefix pt-5 fa fa-envelope" ></i>
                      <select id="currency" name="currency" >
                        ...
                        foreach ($listCurrencies as $currency) {
                          ?>
                           <option value="<?php echo $currency['code']; ?>"><?php echo $currency['designation'] . '(' . $currency['code']. ')'; ?></option>
                          <?php
                        }
                       ?>
                      </select>
                      <label for="currency" class="center-align">Devise</label>
                    </div>
          ...
          <div class="row margin">
            <div class="input-field col s12 m6 l6">
                      <i class="prefix pt-5 fa fa-envelope" ></i>
                      <input id="productLogo" type="file" name="product_logo" required="">
                      <label for="productLogo" class="center-align">Logo</label>
                    </div>
          ...
          <input type="hidden" name="operation" value="exeAddProduct">
